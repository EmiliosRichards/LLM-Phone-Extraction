...
# Global logging level - can be overridden via SCRAPER_LOG_LEVEL env var
level_name = os.getenv('SCRAPER_LOG_LEVEL', 'DEBUG')
LOG_LEVEL: int = getattr(logging, level_name, logging.DEBUG)
...
def set_output_directory(output_dir: Path) -> None:
    ...
    DATA_DIR = output_dir
    SCRAPING_DIR = output_dir / "scraping"
